/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/libcep_feat/RCS/s2_feat.c,v 1.6 97/07/16 11:36:22 eht Exp $
 *
...
static char rcsid[] = "@(#)$Id: s2_feat.c,v 1.6 97/07/16 11:36:22 eht Exp $";
...

uint32
s2_feat_blksize(uint32 veclen)
{
    int i;
    uint32 size;

    s2_feat_set_in_veclen(veclen);
		...
		uint32 veclen)
{
    ...
    out = s2_feat_alloc(n_frame, veclen);
