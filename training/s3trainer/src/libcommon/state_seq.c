/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/libcommon/RCS/state_seq.c,v 1.5 97/07/17 07:10:53 eht Exp $
 *
 ...
 *********************************************************************/

static char rcsid[] = "@(#)$Id: state_seq.c,v 1.5 97/07/17 07:10:53 eht Exp $";
