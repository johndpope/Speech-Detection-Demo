/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/libcommon/RCS/acmod_set.c,v 1.11 97/07/16 11:36:22 eht Exp $
 *
 ...
 *********************************************************************/

static char rcsid[] = "@(#)$Id: acmod_set.c,v 1.11 97/07/16 11:36:22 eht Exp $";
