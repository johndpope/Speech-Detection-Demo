...
static char rcsid[] = "@(#)$Id: segdmp.c,v 1.2 97/07/16 11:36:22 eht Exp Locker: eht $";
...
/* Assuming sequential id access */
static long *idx_off;
static uint32 d_id = NO_ID;
static uint32 *d_off = NULL;
static uint32 *d_len = NULL;
static uint32 d_next = 0;
