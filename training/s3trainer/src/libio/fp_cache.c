/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/libio/RCS/fp_cache.c,v 1.2 97/07/16 11:36:22 eht Exp $
 *
...
static char rcsid[] = "@(#)$Id: fp_cache.c,v 1.2 97/07/16 11:36:22 eht Exp $";
