/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/bw/RCS/accum.c,v 1.21 97/07/16 11:36:22 eht Exp Locker: eht $
 *
 ...
 *********************************************************************/

static char rcsid[] = "@(#)$Id: accum.c,v 1.21 97/07/16 11:36:22 eht Exp Locker: eht $";
...
/* RSINGH: MODIFIED FOR PARALLEL BW g->veclen TO veclen */
				  feat, veclen[j]);
/* END MODIFICATION */
	    }
	    else {
