...
train_cmd_ln_parse(int argc, char *argv[])
{
	...
	{ "-cepext_2ndfeat",
	  ...
	  CMD_LN_NO_VALIDATION,
	  "mfc",
	  "The cepstrum file extension for the second feature" },
	...
	{ "-cepdir_2ndfeat",
	  ...
	  CMD_LN_NO_VALIDATION,
	  CMD_LN_NO_DEFAULT,
	  "The cepstrum data root directory for the 2nd feature" },

	{ "-parallelbw",
	  CMD_LN_STRING,
	  CMD_LN_NO_VALIDATION,
	  "no",
	  "Parallel Baum Welch flag"},
	...
	{ "-ceplen_2ndfeat",
	  ...
	  CMD_LN_NO_VALIDATION,
	  "13",
	  "The length of the second input feature (e.g. MFCC) vectors"},

	{ "-agc",
	  CMD_LN_STRING,
	  CMD_LN_NO_VALIDATION,
	  "none",
	  "The type of automatic gain control to do {none|max|emax}"},
	...
	{ "-agc_2ndfeat",
	  ...
	  CMD_LN_NO_VALIDATION,
	  "none",
	  "The type of automatic gain control to do {none|max|emax} for the parallel feature"},

	{ "-cmn_2ndfeat",
	  CMD_LN_STRING,
	  CMD_LN_NO_VALIDATION,
	  "current",
	  "To do cepstral mean normalization based on {current|prior} utterance(s) of the parallel feature"},

	{ "-varnorm_2ndfeat",
	  CMD_LN_STRING,
	  CMD_LN_NO_VALIDATION,
	  "no",
	  "Variance Normalize the parallel feature?"},
	...
	{ "-feat_2ndfeat",
	  ...
	  CMD_LN_NO_VALIDATION,
	  CMD_LN_NO_DEFAULT,
	  "Derived feature computation to use for the second feature."},
