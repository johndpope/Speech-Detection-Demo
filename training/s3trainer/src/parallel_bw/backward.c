/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/bw/RCS/backward.c,v 1.20 97/07/16 11:36:22 eht Exp Locker: eht $
 *
 ...
 *********************************************************************/

static char rcsid[] = "@(#)$Id: backward.c,v 1.20 97/07/16 11:36:22 eht Exp Locker: eht $";
...
/* END ADDITION */
	        accum_gauden(denacc,
			 cb_inv,
			 n_lcl_cb,
/* RSINGH: MODIFIED feature TO feature2 AND ADDED feat2_vecsize FOR PARALLEL BW */
			 feature2[t+1],
			 (uint32 *)feat2_vecsize(),
/* END ADDITION */
			 spkr_xfrm_ainv,
			 spkr_xfrm_b,
			 now_den_idx,
	        ...
	        accum_gauden(denacc,
			 cb_inv,
			 n_lcl_cb,
/* RSINGH: ADDED feat_vecsize, FOR PARALLEL BW */
			 feature[t+1],
			 (uint32 *)feat_vecsize(),
/* END ADDITION */
			 spkr_xfrm_ainv,
