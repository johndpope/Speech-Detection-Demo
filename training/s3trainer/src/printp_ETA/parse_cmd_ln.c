/*********************************************************************
 *
 * $Header: /net/alf19/usr2/eht/s3/src/printp/RCS/parse_cmd_ln.c,v 1.6 97/07/16 11:36:22 eht Exp $
 *
...
static char rcsid[] = "@(#)$Id: parse_cmd_ln.c,v 1.6 97/07/16 11:36:22 eht Exp $";
...
parse_cmd_ln(int argc, char *argv[])
{
	...
	{ "-tmateta",
	  ...
	  CMD_LN_NO_VALIDATION,
	  "1e+20",
	  "Power to which (1/Nedge) must be raised in tmat scaling factor"},

	{ "-skipstate",
	  CMD_LN_BOOLEAN,
	  CMD_LN_NO_VALIDATION,
	  "no",
	  "Whether tmat allows skipstate"},
