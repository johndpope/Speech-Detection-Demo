...
#ifndef lint
static char NgramStats_Copyright[] = "Copyright (c) 1995-2008 SRI International.  All Rights Reserved.";
static char NgramStats_RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/NgramStats.cc,v 1.56 2008/09/08 23:07:02 stolcke Exp $";
#endif
...
NgramCounts<CountT>::NgramCounts(Vocab &vocab, unsigned int maxOrder)
    : LMStats(vocab), order(maxOrder), intersect(false)
{
}
