...
#ifndef lint
static char Copyright[] = "Copyright (c) 1995-2008 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/NBest.cc,v 1.70 2008/04/24 19:29:32 stolcke Exp $";
#endif
...
NBestList::NBestList(Vocab &vocab, unsigned maxSize,
    ...
    : vocab(vocab), _numHyps(0),
      hypList(0, initialSize), maxSize(maxSize), multiChar(0),
...
NBestList::NBestList(Vocab &vocab, unsigned maxSize,
    ...
    : vocab(vocab), _numHyps(0),
      hypList(0, initialSize), maxSize(maxSize), multiChar(multiChar),
      backtrace(backtrace), acousticOffset(0.0)
{
}
