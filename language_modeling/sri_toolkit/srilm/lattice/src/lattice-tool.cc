...
#ifndef lint
static char Copyright[] = "Copyright (c) 1997-2008 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Id: lattice-tool.cc,v 1.141 2008/10/07 19:16:19 stolcke Exp $";
#endif
