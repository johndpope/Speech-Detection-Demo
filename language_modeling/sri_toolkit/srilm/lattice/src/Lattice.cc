...
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lattice/src/RCS/Lattice.cc,v 1.125 2008/10/07 19:16:19 stolcke Exp $";
#endif
...
Lattice::Lattice(Vocab &vocab, const char *name)
    : name(strdup(name != 0 ? name : LATTICE_NONAME)),
      ...
      duration(0.0), vocab(vocab), ignoreVocab(vocab), keepUnk(false),
...
Lattice::writeCompactPFSG(File &file)
{
	...
	*nodeMap.insert(nodeIndex) = numNodes ++;
	...
	fprintf(file, " %s", (!printSentTags && nodeIndex == initial ||
